...
# For creating document projection embeddings
# Confusingly, this is not the same as DocumentDataset
...
__all__ = ['DocumentDataset', 'TwoTowerModel', 'DocDataset', 'collate_docdataset']